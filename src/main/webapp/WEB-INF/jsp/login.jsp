...
<body>
	<div class="container" style="margin-top: 100px">
		<form class="col-md-offset-4 col-md-4 form form-horizontal"
			action="/mgt/login" method="post" id="login_form">
			<h3 class="text-center">用户登录</h3>
			<div class="form-group">
				<label for="username" class="col-md-2 control-label">账&nbsp;户:</label>
				<div class="col-md-10">
					<input type="text" class="form-control" id="username"
						name="username" placeholder="请输入用户名"> <span class="err"></span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="password" class="form-control" id="passwd"
						name="passwd" placeholder="请输入密码"> <span
						class="glyphicon glyphicon-eye-close passwd-eye"></span> <span
						class="err"></span>
				</div>
			</div>
